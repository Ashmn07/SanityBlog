...
function Post({post}:PostProp) {
  ...
  console.log(post);
  const {handleSubmit,register,formState:{errors}} = useForm<InpForm>()
  const [submitted,setSubmitted] = useState(false)

  const onSubmit:SubmitHandler<InpForm> = async(data)=>{
  ...
  return (
        <main>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col p-5 my-10 max-w-2xl mx-auto mb-10">
                <h3 className="text-md text-green-600">What do you think about the article?</h3>
                <h4 className="text-3xl font-bold">Share your thoughts below!</h4>
                ...
                <label className="block mb-5 mt-2">
                    ...
                    className="shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-green-600
                ...
                <label className="block mb-5 mt-2">
                    ...
                    className="shadow border rounded py-2 px-3 form-textarea mt-1 block w-full ring-green-600
                    outline-none focus:ring" 
                ...
                <input 
                className="shadow bg-green-600 hover:bg-green-500 cursor-pointer focus:shadow-outline
            ...
            <div className="flex flex-col p-10 my-10 max-w-2xl mx-auto shadow-green-600 shadow space-y-2">
                ...
                {post.comments.map((c) =>(
                    <div key={c._id}>
                        <p>
                            <span className="text-green-600">{c.name}: </span>{c.comment}
                        </p>
                    </div>
                ))}
            </div>
